...
const initialToddyShops = [
    ...
    },
    {
        ...
        description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rhoncus, arcu at rhoncus ullamcorper, nulla dui enim, eu laoreet felis nisi ut dolor. Read More",
        rating: 4.0,
        reviewsCount: 106,
    ...
    return (
        <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-x-0 top-0 bottom-0 z-[1000] pointer-events-none p-4 flex flex-col gap-4 items-start justify-between">
                ...
                <div className="absolute bottom-5 w-full md:w-[450px] pointer-events-auto self-center md:self-auto md:ml-[350px]">
                    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-100 dark:border-slate-800/50 flex items-center p-1.5 pl-4 transition-all duration-200 focus-within:ring-2 focus-within:ring-[#003e1c]/25 focus-within:border-[#003e1c]">
                        <Search
                            className={`w-5 h-5 text-[#003e1c] dark:text-emerald-500 shrink-0 ${isSearching ? "animate-pulse" : ""}`}
                        />
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-3 w-full md:w-[320px] pointer-events-auto shrink-0 z-[1001] hidden md:flex">
                    ...
                    <div className="p-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-100 dark:border-slate-800/50">
                        <h1 className="text-xl font-bold font-heading text-[#003e1c] dark:text-emerald-400">
                            Kerala Toddy Finder
                        </h1>
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                            Discover traditional, authentic toddy shops across
                            Kerala.
                        </p>
                                ...
                                <div>
                                    <div className="flex items-start justify-between gap-2">
                                        ...
                                        <div className="flex items-center gap-1.5 shrink-0 mt-1">
                                            ...
                                            >
                                                <Heart
                                                    className={`w-3.5 h-3.5 ${isFavorite ? "fill-red-500" : ""}`}
                                                />
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <div className="w-full xl:w-[58%] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800/80 p-5 flex flex-col justify-between gap-4">
                            ...
                            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800">
                                <div className="flex gap-6">
                                    {["overview", "reviews", "recommended"].map(
                                        (tab) => (
                                            <button
                                                key={tab}
                                                onClick={() =>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 p-4 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800/50">
                                        ...
                                        <div className="md:col-span-7 flex flex-col gap-3">
                                            <div className="flex items-start gap-2.5">
                                                ...
                                                <div>
                                                    <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wide leading-none">
                                                        Address
                                                    </p>
                                                    <p className="text-xs text-slate-600 dark:text-slate-300 font-bold mt-0.5 leading-snug">
                                                        {
                                                            selectedShop.locationName
                                                        }
                                                    </p>
                                            ...
                                            <div className="flex items-start gap-2.5">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-600 dark:text-slate-300 font-bold mt-0.5 leading-none">
                                                        {selectedShop.hours}{" "}
                                                        <span className="text-emerald-700 dark:text-emerald-400 font-black ml-1">
                                                            (Open Today)
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <div className="flex items-start gap-2.5">
                                                ...
                                                <div>
                                                    ...
                                                    <a
                                                        href={`https://${selectedShop.website}`}
                                                        target="_blank"
                                                        rel="noreferrer"
                                                        className="text-xs text-emerald-700 dark:text-emerald-400 font-bold mt-0.5 hover:underline"
                                                    >
                                                ...
                                                <div className="flex flex-col gap-1.5">
                                                    {selectedShop.accessibility.map(
                                                        (item) => (
                                                            <div
                                                                key={item}
                                                                className="flex items-center gap-2 bg-[#f4faf7] dark:bg-emerald-950/20 px-2.5 py-1.5 rounded-lg border border-emerald-500/10"
                                                            >
                                                                {item ===
                                                                    "Parking" && (
                                                                    <Car className="w-3.5 h-3.5 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                                {item ===
                                                                    "Gender Neutral" && (
                                                                ...
                                                                {item ===
                                                                    ...
                                                                    <Accessibility className="w-3.5 h-3.5 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                ...
                                                <div className="grid grid-cols-2 gap-1.5">
                                                    {selectedShop.amenities.map(
                                                        (item) => (
                                                            <div
                                                                key={item}
                                                                className="flex items-center gap-1.5 bg-[#f4faf7] dark:bg-emerald-950/20 px-2 py-1.5 rounded-lg border border-emerald-500/10"
                                                            >
                                                                {item ===
                                                                    "Air Conditioned" && (
                                                                    <Wind className="w-3 h-3 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                                {item ===
                                                                    "Kids Friendly" && (
                                                                    <Baby className="w-3 h-3 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                                {item ===
                                                                    "Clean Toilets" && (
                                                                    <ShowerHead className="w-3 h-3 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                                {item ===
                                                                    "Wi-Fi" && (
                                                                    <Wifi className="w-3 h-3 text-emerald-700 dark:text-emerald-400 shrink-0" />
                                                                )}
                                                                <span className="text-[9px] font-bold text-emerald-800 dark:text-emerald-300 leading-tight">
                                                                    {item}
                                                                </span>
                                                            </div>
                                                        ),
                                        ...
                                        <div className="flex flex-col gap-3 max-h-[220px] overflow-y-auto pr-1">
                                            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800/60 flex flex-col gap-1 shadow-sm">
                                                ...
                                                <p className="text-[11px] text-slate-500 mt-1 leading-relaxed">
                                                    &quot;Outstanding fresh
                                                    sweet toddy and fiery duck
                                                    roast. Truly authentic
                                                    Kerala vibe. Accessible
                                                    parking and fast service.
                                                    Will visit again!&quot;
                                                </p>
                                            </div>
                                            ...
                                            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800/60 flex flex-col gap-1 shadow-sm">
                                                ...
                                                <p className="text-[11px] text-slate-500 mt-1 leading-relaxed">
                                                    ...
                                                    friendly atmosphere. Spicy
                                                    crab was mouthwatering, but
                                                    the seats fill up very
                                                    quickly.&quot;
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            .map((shop) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 flex flex-col justify-between">
                                                        <div>
                                                            <h5 className="font-bold text-xs text-slate-800 dark:text-slate-100 leading-tight line-clamp-1">
                                                                {shop.name}
                                                            </h5>
                                                            <p className="text-[10px] text-slate-400 dark:text-slate-500 font-medium leading-none mt-1">
                                                                📍{" "}
                                                                {
                                                                    shop.locationName.split(
                                                                        ",",
                                                                    )[0]
                                                                }
                                                            </p>
